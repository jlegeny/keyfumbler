...
lines.segment_crosses_line = function(segment, line)
  ...
  if dota < -lines.CROSS_TOLERANCE and dotb < -lines.CROSS_TOLERANCE then
    return -1
  elseif dota > lines.CROSS_TOLERANCE and dotb > lines.CROSS_TOLERANCE then
    return 1
  else
    return 0
  end
